...
- [x] 2.1 Remove explicit `: EnvironmentProviders` return type from `provideCupIcons()`

## 3. Final Verification

- [x] 3.1 Run `bun nx build icons` — build succeeds
- [x] 3.2 Run `bun biome check --write libs/icons/` — formatting clean
- [x] 3.3 Commit: `git add . && git commit -m "refactor(icons): 📦 apply Angular 21 best practices — booleanAttribute, numberAttribute, remove standalone"`
