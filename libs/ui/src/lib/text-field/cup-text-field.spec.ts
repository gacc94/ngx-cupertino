...
import { ALL_ICONS, provideCupIcons } from "../icon";
...
describe("CupTextField", () => {
    ...
    it("should show clear button when clearable and has value", () => {
        ...
        fixture.detectChanges();
        const clear = fixture.nativeElement.querySelector(".clear");
    ...
    it("should clear value on clear button click", () => {
        ...
        fixture.componentInstance.value.set("text");
        fixture.detectChanges();
        const clear = fixture.nativeElement.querySelector(".clear") as HTMLElement;
        clear.click();
    ...
    it("should show helper message", () => {
        ...
        fixture.detectChanges();
        const helper = fixture.nativeElement.querySelector(".helper:not(.error-text)");
    ...
    it("should prioritize error over helper", () => {
        ...
        const helpers = fixture.nativeElement.querySelectorAll(".helper:not(.error-text)");
    ...
    it("should set aria-describedby to helper id", () => {
        ...
        fixture.detectChanges();
        const input = fixture.nativeElement.querySelector(".input") as HTMLInputElement;
        const helperEl = fixture.nativeElement.querySelector(".helper:not(.error-text)");
    ...
    it("should apply focused on focus", () => {
        const fixture = TestBed.createComponent(CupTextField);
        fixture.detectChanges();
        const input = fixture.nativeElement.querySelector(".input") as HTMLInputElement;
        input.dispatchEvent(new Event("focus"));
        fixture.detectChanges();
        expect(fixture.nativeElement.classList.contains("focused")).toBe(true);
    });

    it("should remove focused on blur", () => {
        const fixture = TestBed.createComponent(CupTextField);
        fixture.detectChanges();
        const input = fixture.nativeElement.querySelector(".input") as HTMLInputElement;
        input.dispatchEvent(new Event("focus"));
        ...
        fixture.detectChanges();
        expect(fixture.nativeElement.classList.contains("focused")).toBe(false);
    });
    ...
    it("should apply readonly when readonly", () => {
        const fixture = TestBed.createComponent(ReadonlyHost);
        fixture.detectChanges();
        const host = fixture.nativeElement.querySelector("cup-text-field");
        expect(host.classList.contains("readonly")).toBe(true);
    });

    it("should apply filled when value", () => {
        const fixture = TestBed.createComponent(CupTextField);
        const component = fixture.componentInstance;
        component.value.set("text");
        fixture.detectChanges();
    ...
    it("should apply sm for size sm", () => {
    ...
    it("should apply lg for size lg", () => {
    ...
    it("should not apply size class for md", () => {
        const fixture = TestBed.createComponent(CupTextField);
        fixture.detectChanges();
        expect(fixture.nativeElement.classList.contains("sm")).toBe(false);
        expect(fixture.nativeElement.classList.contains("lg")).toBe(false);
    });
