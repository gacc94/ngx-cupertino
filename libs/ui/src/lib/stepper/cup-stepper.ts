...
@Component({
    ...
    styles: [
        `
            ...
            .cup-stepper-decrement,
            .cup-stepper-increment {
                display: inline-flex;
                align-items: center;
            ...
            .cup-stepper-decrement:hover,
            .cup-stepper-increment:hover {
                background: var(--cup-fill-tertiary);
            }

            .cup-stepper-decrement:disabled,
            .cup-stepper-increment:disabled {
                opacity: 0.3;
                cursor: not-allowed;
            }
            ...
            .cup-stepper-input::-webkit-inner-spin-button,
            .cup-stepper-input::-webkit-outer-spin-button {
                -webkit-appearance: none;
                margin: 0;
            }

            .cup-stepper-input:focus {
                box-shadow: inset 0 0 0 2px var(--cup-tint);
            }
        `,
    ],
})
