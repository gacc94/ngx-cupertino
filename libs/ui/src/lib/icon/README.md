# Icons (part of @ngx-cupertino/ui)

[![npm version](https://img.shields.io/npm/v/@ngx-cupertino/ui?label=icons-in-ui)](https://www.npmjs.com/package/@ngx-cupertino/ui)
...
```bash
npm i @ngx-cupertino/ui @ngx-cupertino/tokens @lucide/angular
```
...
```ts
// app.config.ts
import { provideCupIcons, houseIcon, starFillIcon, magnifyingglassIcon } from "@ngx-cupertino/ui";
...
```ts
// component
import { CupIcon } from "@ngx-cupertino/ui";
...
```ts
import { provideCupIcons, ALL_ICONS } from "@ngx-cupertino/ui";
